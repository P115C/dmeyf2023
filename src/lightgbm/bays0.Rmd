...
PARAM$experimento <- "HT5232" # "HT5230"
...
PARAM$trainingstrategy$undersampling <- 0.3 # 1.0
PARAM$trainingstrategy$semilla_azar <- 886609 # Aqui poner su  primer  semilla

PARAM$hyperparametertuning$iteraciones <- 50 # 100
...
dataset[, t_delinquency := fcase( Master_delinquency > 0, 1,
                                  ...
                                  default = (Master_delinquency | Visa_delinquency) ) ]
...
colnames(dataset)[colnames(dataset) == "mttarjeta_master_debitos_automaticos"] = "mtarjeta_master_debitos_automaticos"
...
cols_pesos <- c("mcuentas_saldo", "mprestamos_personales", "mcuenta_corriente_adicional",
                ...
                "mcuenta_debitos_automaticos", "mtarjeta_visa_debitos_automaticos",
...
rm(mapeo_ipc, col_pesos2)
```


Media en ventana, dif1, dif2:
```{r}
