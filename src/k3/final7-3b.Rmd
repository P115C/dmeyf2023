...
PARAM$finalmodel$optim$num_iterations <- 1184
PARAM$finalmodel$optim$learning_rate <- 0.054133	
PARAM$finalmodel$optim$feature_fraction <- 0.950158
PARAM$finalmodel$optim$min_data_in_leaf <- 40809
PARAM$finalmodel$optim$num_leaves <- 368	
