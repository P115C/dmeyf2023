...
PARAM$finalmodel$optim$num_iterations <- 802
PARAM$finalmodel$optim$learning_rate <- 0.076732		
PARAM$finalmodel$optim$feature_fraction <- 0.434858
PARAM$finalmodel$optim$min_data_in_leaf <- 21693	
PARAM$finalmodel$optim$num_leaves <- 894	
