...
PARAM$finalmodel$optim$num_iterations <- 1690
PARAM$finalmodel$optim$learning_rate <- 0.037502	
PARAM$finalmodel$optim$feature_fraction <- 0.330423
PARAM$finalmodel$optim$min_data_in_leaf <- 41644
PARAM$finalmodel$optim$num_leaves <- 1484	
