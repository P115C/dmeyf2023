...
PARAM$finalmodel$optim$num_iterations <- 652
PARAM$finalmodel$optim$learning_rate <- 0.028318	
PARAM$finalmodel$optim$feature_fraction <- 0.969223
PARAM$finalmodel$optim$min_data_in_leaf <- 11353
PARAM$finalmodel$optim$num_leaves <- 652	
