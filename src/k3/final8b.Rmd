...
PARAM$finalmodel$optim$num_iterations <- 437
PARAM$finalmodel$optim$learning_rate <- 0.099393	
PARAM$finalmodel$optim$feature_fraction <- 0.511026
PARAM$finalmodel$optim$min_data_in_leaf <- 24517
PARAM$finalmodel$optim$num_leaves <- 1634	
