...
```
```{r}
# Empezando a probar con menos casos
set.seed(semillas[1])
...
ctrl <- makeMBOControl()
ctrl <- setMBOControlTermination(ctrl, iters = 128L)
ctrl <- setMBOControlInfill(
  ctrl,
  crit = makeMBOInfillCritEI(),
  opt = "focussearch",
...
```{r}
# ternario gridsearch:
#   maxdepth=5; minsplit=500; minbucket=50

# Con clase_binaria y auc en prueba (promediado en semillas), y con bayesiano:
#   maxdepth=11; minsplit=200; minbucket=1
#   maxdepth=16; minsplit=236; minbucket=1
#   maxdepth=10; minsplit=248; minbucket=1

# bayesiana ternaria con cv:
#   maxdepth=12; minsplit=1733; minbucket=378
