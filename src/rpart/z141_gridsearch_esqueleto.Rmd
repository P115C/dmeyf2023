...
PARAM$semillas <- c(552581, 892237, 200177)
```
...
archivo_salida <- "./exp/HT2023/gridsearch_3.txt"
...
for (vmax_depth in c(4, 5, 6, 10, 15)) {
  for (vmin_split in c(1000, 600, 500, 300)) {
    for (vmin_bucket in c(2, 5, as.integer(vmin_split/100), as.integer(vmin_split/10))) {
