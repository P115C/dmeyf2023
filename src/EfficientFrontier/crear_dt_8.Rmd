...
PARAM$input$todos_meses <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912,
                          # 202001, 202002, 202003, 202004, 202005, 202006, 202007, 202008, 202009,
                          202010, 202011, 202012,
...
```{r}
dataset = dataset[ foto_mes %in% PARAM$input$todos_meses ]

dataset[, fold_final_train := 0]
dataset[, fold_future := 0]
dataset[foto_mes %in% PARAM$input$training, fold_final_train := 1]
dataset[foto_mes %in% PARAM$input$future, fold_future := 1]
```
...
fwrite(dataset,
  file = paste0("dataset_training.csv.gz"),
  sep = ","
)
